...
## 1. Live token counter — ✅ COMMITTED `b450242`, NOT live-verified
...
## 3. Activity panel repolish — ⬜ 🧩 (user delegated all execution calls)
...
## 5. Composer drag-and-drop broken — ⬜ 🧩
...
## 6. Streaming / output rendering — ⬜ 🧩 (subjective — treat as latency + consistency pass)
