...
Small, focused PRs land fastest. [`DEVELOPING.md`](DEVELOPING.md) covers
everything from clone to the pre-PR checklist;
...
- **Before opening a PR** — run the checks in the
  [Verification section](DEVELOPING.md#verification)
