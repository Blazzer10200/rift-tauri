...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::assistant_get_base_url,
            commands::assistant_set_base_url,
            commands::assistant_get_provider_model,
            commands::assistant_set_provider_model,
            commands::assistant_list_providers,
            commands::assistant_save_provider,
            commands::assistant_delete_provider,
            commands::assistant_set_active_provider,
            ...
            commands::assistant_save_session_log,
            commands::assistant_list_session_logs,
            commands::assistant_load_session_log,
            commands::assistant_delete_session_log,
            commands::assistant_prune_session_logs,
