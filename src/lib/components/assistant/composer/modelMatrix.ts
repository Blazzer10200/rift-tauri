...
export const MODEL_OPTIONS: ModelOpt[] = [
  ...
  { id: "claude-sonnet-4-5", label: "Sonnet", version: "4.5", tagline: "Classic Sonnet — everyday workhorse, 200K context",        blurb: "Classic Sonnet generation", ctx: "200K ctx", suffix: "200K context", legacy: true, effort: true,  maxEffort: MODEL_MAX_EFFORT["claude-sonnet-4-5"], icon: Feather },
];
